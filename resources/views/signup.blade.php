...
@section('styles')
    ...
    <link href="{{ URL::asset('vendor/css/signupstyle.css')}}" rel="stylesheet">
    ...
    <form class="form-horizontal " role="form" method="POST" action="{{route('register')}}">
      ...
      <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class=" mb-2 mr-sm-2 mb-sm-0">
                        <input type="date"  value="1995-08-19" name="dateOfBirth" class="form-control" id="date"
        ...
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <button type="submit" class="btn btn-success btn-block signupbtn"><i class="fa fa-user-plus"></i> Register</button>
            </div>
        </div>
